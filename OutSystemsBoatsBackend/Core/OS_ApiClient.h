 ...
 */
extern NSString *const OS_ResponseObjectErrorKey;

@interface OS_ApiClient : AFHTTPSessionManager

@property(nonatomic, assign) NSURLRequestCachePolicy cachePolicy;
@property(nonatomic, assign) NSTimeInterval timeoutInterval;
@property(nonatomic, readonly) NSOperationQueue* queue;

/// In order to ensure the HTTPResponseHeaders are correct, it is recommended to initialize one OS_ApiClient instance per thread.
@property(nonatomic, readonly) NSDictionary* HTTPResponseHeaders;

@property(nonatomic, strong) id<OS_ResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<OS_Sanitizer> sanitizer;
/**
 * Clears Cache
 */
+(void)clearCache;
...
/**
 * OS_Configuration return sharedConfig
 *
