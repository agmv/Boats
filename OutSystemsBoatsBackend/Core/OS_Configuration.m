#import "OS_Configuration.h"

@interface OS_Configuration ()
...
@implementation OS_Configuration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static OS_Configuration *shardConfig = nil;
...
- (instancetype) init {
    ...
    if (self) {
        self.apiClient = nil;
        self.host = @"https://E1O0V-DV2D50.outsystemsenterprise.com/BoatsBackend/rest/Boats";
        self.username = @"";
        self.password = @"";
        self.accessToken= @"";
        self.verifySSL = YES;
        ...
        self.mutableDefaultHeaders[@"User-Agent"] = [NSString stringWithFormat:@"Swagger-Codegen/1/objc (%@; iOS %@; Scale/%0.2f)",[[UIDevice currentDevice] model], [[UIDevice currentDevice] systemVersion], [[UIScreen mainScreen] scale]];
        self.logger = [OS_Logger sharedLogger];
    }
    return self;
}
