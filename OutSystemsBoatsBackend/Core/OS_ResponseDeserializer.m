#import "OS_ResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const OS_DeserializationErrorDomainKey = @"OS_DeserializationErrorDomainKey";

NSInteger const OS_TypeMismatchErrorCode = 143553;

NSInteger const OS_EmptyValueOccurredErrorCode = 143509;

NSInteger const OS_UnknownResponseObjectErrorCode = 143528;


@interface OS_ResponseDeserializer ()
...
@implementation OS_ResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:OS_DeserializationErrorDomainKey code:OS_TypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:OS_DeserializationErrorDomainKey code:OS_EmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:OS_DeserializationErrorDomainKey code:OS_UnknownResponseObjectErrorCode userInfo:userInfo];
}
