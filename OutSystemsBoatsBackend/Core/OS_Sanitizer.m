#import "OS_Sanitizer.h"
#import "OS_Object.h"
#import "OS_QueryParamCollection.h"
#import <ISO8601/ISO8601.h>

NSString * OS_PercentEscapedStringFromString(NSString *string) {
    static NSString * const kOS_CharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kOS_CharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kOS_CharactersGeneralDelimitersToEncode stringByAppendingString:kOS_CharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[OS_QueryParamCollection class]]) {
        return object;
    }
    ...
    else if ([object isKindOfClass:[OS_Object class]]) {
